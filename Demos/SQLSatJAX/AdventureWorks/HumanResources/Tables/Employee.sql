CREATE TABLE [HumanResources].[Employee] (
    ...
    CONSTRAINT [CK_Employee_Gender] CHECK ([Gender]=N'M' OR [Gender]=N'F' OR [Gender]=N'NB'),
    CONSTRAINT [CK_Employee_HireDate] CHECK ([StartDate]>='1996-07-01' AND [StartDate]<=dateadd(day,(1),getdate())),
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Employee hired on this date.', @level0type = N'SCHEMA', @level0name = N'HumanResources', @level1type = N'TABLE', @level1name = N'Employee', @level2type = N'COLUMN', @level2name = N'StartDate';
